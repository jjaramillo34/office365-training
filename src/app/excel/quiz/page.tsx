      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Excel Quiz Results</h1>
            <p className="text-gray-600">You've completed the Microsoft Excel assessment</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="flex items-center justify-center gap-2 px-8 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-semibold">
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Microsoft Excel Quiz</h1>
          <p className="text-gray-600">Test your knowledge of Microsoft Excel</p>
        </div>
            ...
            {question.options.map((option, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-6 rounded-full border-2 flex items-center justify-center ${
                    selectedAnswer === index
                      ? isCorrect
                        ? "border-green-500"
                        : "border-red-500"
