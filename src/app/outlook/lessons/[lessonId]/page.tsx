...
export async function generateStaticParams() {
  ...
  try {
    ...
    console.log("Using fallback Outlook lesson params:", fallbackParams);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="sticky top-8">
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                <h3 className="text-lg font-bold text-gray-900 flex items-center mb-4">
                  <BookOpen size={20} className="mr-2 text-orange-600" />
                  Lesson Sections
                </h3>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-12 flex justify-between items-center">
              ...
              <Link
                href="/outlook/quiz"
                className="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-orange-600 to-amber-600 border border-transparent rounded-xl hover:from-orange-700 hover:to-amber-700 transition-all duration-200 shadow-lg"
              >
                Take Quiz
