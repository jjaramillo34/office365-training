...
export default function OutlookQuizPage() {
  ...
  const handleAnswerSelect = (answerIndex: number) => {
    ...
    const correct = answerIndex === outlookQuiz[currentQuestion].correct;
  ...
  const handleNext = () => {
    if (currentQuestion < outlookQuiz.length - 1) {
  ...
  const progress = (currentQuestion / outlookQuiz.length) * 100;
  const question = outlookQuiz[currentQuestion];

  if (showResults) {
    const percentage = Math.round((score / outlookQuiz.length) * 100);
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="text-2xl font-bold text-orange-600">Correct Answers</div>
                  <div className="text-gray-600">Correct Answers</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="text-2xl font-bold text-gray-600">{outlookQuiz.length - score}</div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium text-gray-600">
                Question {currentQuestion + 1}/{outlookQuiz.length}
              </span>
              <span className="text-sm font-medium text-gray-600">
                Score: {score}/{outlookQuiz.length}
              </span>
            </div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-3">
            <div 
              className="bg-gradient-to-r from-orange-500 to-red-500 rounded-full transition-all duration-300 ease-out"
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              {currentQuestion === outlookQuiz.length - 1 ? "Finish Quiz" : "Next"}
